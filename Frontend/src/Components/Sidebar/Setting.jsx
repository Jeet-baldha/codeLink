...
function Setting({ width, setWidth }) {
    ...
    return (
        <div style={style} className={`overflow-hidden text-white bg-card/80 backdrop-blur h-full py-10 duration-200 `}>
            <div className='flex text-xl py-2 items-center justify-between px-5'>
                <h1 className=' text-2xl font-bold text-white ' >Settings</h1>
                <IoIosCloseCircle className=' hover:cursor-pointer text-2xl text-white' onClick={() => setWidth(0)} />
            </div>
            <div className=' px-5'>
                <h1 className=' text-xl py-2 text-white'>Select Your Language: </h1>
            ...
            <div className=' px-5'>
                <h1 className=' text-xl py-2 text-white'>Select Your Theme: </h1>
            ...
            <div className=' px-5 flex gap-10 py-5 items-center'>
                <h1 className=' text-xl py-2 text-white'>Select Font Size: </h1>
