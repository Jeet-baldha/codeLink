...
function SignUp() {
    ...
    return (
        ...
        <div className=' bg-white rounded-md p-5'>
            ...
            <div className=''>
                    <button aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-2 px-4 border rounded-lg border-gray-700 flex items-center w-full">
