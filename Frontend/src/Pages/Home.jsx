    ...
    const features = [
        {
            ...
            description: "Collaborative coding with instant synchronization across all participants"
        },
        {
            icon: Video,
            title: "Video Calling",
            description: "Built-in video calls for seamless communication while coding"
        },
        {
            icon: Globe,
        ...
        },
        {
            ...
            description: "Fetch and solve LeetCode problems collaboratively using problem URLs"
        },
        {
            icon: Zap,
            title: "Custom Themes",
            description: "Multiple editor themes to match your coding preferences"
        },
        {
            icon: Users,
            title: "Team Collaboration",
            description: "Multiple users can code together in real-time"
        }
    ];

    return (
        <div className="min-h-screen bg-dark-blue-black text-white">
            {/* Navigation */}
            <nav className="border-b border-dark-grayish-blue bg-dark-blue-black/50 backdrop-blur-sm sticky top-0 z-50">
                <div className="container mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                        <div className="w-8 h-8 rounded-lg bg-light-bluish-green flex items-center justify-center">
                            <Code2 className="w-5 h-5 text-dark-blue-black" />
                        </div>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        <a href="#features" className="text-light-gray hover:text-white transition-colors text-lg">Features</a>
                        <a href="#about" className="text-light-gray hover:text-white transition-colors text-lg">About</a>
                        <a href="#contact" className="text-light-gray hover:text-white transition-colors text-lg">Contact</a>
                    </div>
                    
                    <div className="flex items-center space-x-4">
                        <Button variant="ghost" className="text-white hover:bg-dark-grayish-blue">
                            Sign In
                        </Button>
                        <Button className="bg-light-bluish-green text-dark-blue-black hover:bg-light-bluish-green/90">
                            Get Started
                        </Button>
                    </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Badge className="mb-6 bg-gradient-to-r from-accent to-primary text-accent-foreground">
          ...
          <p className="text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Real-time collaborative coding with video calls, multi-language support, and LeetCode integration. 
            Perfect for pair programming, interviews, and team development.
          </p>
          ...
          <div className="relative">
            <Card className="p-6 bg-card/80 backdrop-blur glow-primary animate-float">
              ...
              <div className="text-left font-mono text-sm bg-muted p-4 rounded-lg">
                ...
                <div className="text-primary">function</div> <div className="text-foreground">solveTwoSum(nums, target) {`{`}</div>
      ...
      <section id="features" className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-2xl text-muted-foreground max-w-2xl mx-auto">
            Everything you need for collaborative coding, from real-time editing to video communication
          </p>
        </div>
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-2xl text-muted-foreground mb-8">
            Join thousands of developers who are already collaborating on CodeLink
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            {/* Footer */}
            <footer className="border-t border-dark-grayish-blue bg-dark-blue-black/50 backdrop-blur">
                <div className="container mx-auto px-6 py-12">
                    ...
                    <div className="mt-8 pt-8 border-t border-dark-grayish-blue text-center text-light-gray">
